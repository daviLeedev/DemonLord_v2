...
namespace DemonLord.Presentation.Combat
{
    ...
    public sealed class CombatTrainingCoordinator : MonoBehaviour
    {
        ...
        private DialogueFocusController subscribedDialogue;
        ...
        private void OnDialogueCompleted(PrototypeInteractable interactable)
        {
            if (interactable != null
                && string.Equals(interactable.StableId, LiaisonStableId, StringComparison.Ordinal))
            {
                BeginTraining();
            }
        }
        ...
        {
            if (dialogueController != null && subscribedDialogue != dialogueController)
            {
                if (subscribedDialogue != null)
                {
                    subscribedDialogue.DialogueCompleted -= OnDialogueCompleted;
                }

                dialogueController.DialogueCompleted += OnDialogueCompleted;
                subscribedDialogue = dialogueController;
            }
